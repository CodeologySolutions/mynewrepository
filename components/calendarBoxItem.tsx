...
const CalendarBoxItem = ({item, onPress }: ItemProps) => {
   ...
   // let imageUrl="https://codeologyforall.in/templeapi/uploads/"+item.image;
    ...
    return (
        <TouchableOpacity key={timeStamp} style={{height:95, width:260, margin:3,backgroundColor: '#ffd8a1',borderRadius:10, }}  activeOpacity={0.9} onPress={() => onPress(item.id)} >
...
export default CalendarBoxItem;