...
import { View, Modal, Image, ImageBackground, Text, TouchableOpacity, StyleSheet, ScrollView, Dimensions  } from 'react-native';
...
const CustomHeader = (props ) => {
  ...
  const handleButton = (screenName) => {
    ...
    return (
      <View style={{  flexDirection: 'row', height: 62 , width:"100%" , backgroundColor: '#E58200'    }} >
          <ImageBackground source={{uri:"https://codeologyforall.in/templeapi/uploads/header-design.png"}} resizeMode="cover" style={{
          ...
          <View style={{flex: 1, height: 62, width:250 }} >
        ...
        />
          ...
          <TouchableOpacity   onPress={() => handleButton(Constants.nav_bottom_navigation)}  activeOpacity={0.9}   >
          <Image
          style={{
            width: 212,
            height: 31,
          ...
          source={require('../assets/images/temple-logo.png')}
        />
        </TouchableOpacity>
        </View>
         
          <View style={{flex: 2,height: 62,  width:62}} >
          <TouchableOpacity   onPress={() => handleButton(Constants.nav_alarm)}  activeOpacity={0.9}   >
      ...
      />
                      ...
                      <View  style={{height:75, width:boxWidth, backgroundColor: '#7e1615',borderRadius:10,flex: 1, flexDirection: 'row' }}>
                        <View style={{height:110,width:120, flex: 1, flexDirection: 'row', padding: 5, position:"relative" }}>
                            <Image style={{height:55, width:55, borderRadius:8,  flex: 1,
                              ...
                              />
                              <TouchableOpacity style={{ backgroundColor: '#d90000', padding:10, borderBottomLeftRadius: 8, borderTopRightRadius: 8, position:'absolute',zIndex:9999, right:0,top:0}} activeOpacity={0.9} onPress={() => handleButton(Constants.nav_user_upgrade)}  >
        ...
        <Image style={{height:28, width:28, borderRadius:8,  flex: 1,
          ...
          <View style={{ flex: 2, flexDirection: 'row', padding: 5, position:"relative",height:30 ,left:35, top:23 }}>
            ...
            <View style={{backgroundColor: '#fff', width:sideMenuWidth,  alignItems: 'center'}}>
...
<TouchableOpacity  style={{height:60, width:boxWidth, margin:10,backgroundColor: '#f2f2f2',borderRadius:10, }}  onPress={() => handlLogoutButton()} activeOpacity={0.9}   >
